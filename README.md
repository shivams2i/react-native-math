...
- [`android/`](android): All your `android`-specific implementations.
  ...
  - [`src/main/java/com/margelo/nitro/math/`](android/src/main/java/com/margelo/nitro/math/): All Kotlin implementations.
    - [`NitroMathPackage.java`](android/src/main/java/com/margelo/nitro/math/NitroMathPackage.java): The react-native package. You need this because the react-native CLI only adds libraries if they have a `*Package.java` file. In here, you can autolink all Kotlin HybridObjects.
